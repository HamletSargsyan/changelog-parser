...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "Extra space(s) at end of line (at line 1, column 33)",
            1,
            33,
        ),
        (
            "## [1.1.1] - 2023-03-05  [YANKED]",
            "Extra space(s) after date (at line 1, column 24)",
            1,
            24,
        ),
        (
            "## [1.1.1] - 2023-03-05 [ASDF]",
            'Unable to parse changelog entry date, "2023-03-05 [ASDF]" '
            "(at line 1, column 14)",
            1,
            14,
        ),
        (
            "## [1.1.1] - 2023-03-05 ",
            "Extra space(s) at end of line (at line 1, column 24)",
            1,
            24,
        ),
        (
            "## [1.1.1] - hjksdgfwiuehf",
            'Unable to parse changelog entry date, "hjksdgfwiuehf" '
            "(at line 1, column 14)",
            1,
            14,
        ),
        (
            "## [1.1.1] -  2023-03-05",
            "Extra space(s) before date (at line 1, column 14)",
            1,
            14,
        ),
        (
            "## [1.1.1] 2023-03-05",
            'Version and date must be separated by " - " (at line 1, column 11)',
            1,
            11,
        ),
        (
            "## [1.1.1]  - 2023-03-05",
            "Extra space(s) after version (at line 1, column 11)",
            1,
            11,
        ),
        ...
        (
            "## [1.1.1",
            "Version must be enclosed with square brackets (at line 1, column 10)",
            1,
            10,
        ),
        (
            "## 1.1.1]",
            "Version must be enclosed with square brackets (at line 1, column 4)",
            1,
            4,
        ),
        (
            "##  [1.1.1] - 2023-03-05",
            "Extra space(s) before version (at line 1, column 4)",
            1,
            4,
        ),
        (
            "## [asdfasdf]",
            'Failed parsing semver version, "asdfasdf" ' "(at line 1, column 5)",
            1,
            5,
        ),
        (
            "## [Unreleased]\nasdf",
            'Unrecognized line pattern, "asdf" (at line 2)',
            2,
            None,
        ),
        (
            "## [Unreleased]\n### asdf",
            'Invalid change type, "asdf" (at line 2, column 5)',
            2,
            5,
        ),
        (
            "## [Unreleased]\n\n### asdf",
            'Invalid change type, "asdf" (at line 3, column 5)',
            3,
            5,
        ),
        (
            "## [Unreleased]\n\n- Change",
            "Change not under a category section (at line 3)",
            3,
            None,
        ),
        (
            "## [Unreleased]\n\n### Added\n\n### Added",
            'Multiple "Added" sections found (at line 5, column 5)',
            5,
            5,
        ),
        (
            ...
            '"1.1.1" (at line 3, column 2)',
            3,
            2,
        ),
        (
            "## [Unreleased]\n\n[1.a.1]: https://asdf",
            'Failed parsing semver version, "1.a.1" ' "(at line 3, column 2)",
            3,
            2,
        ),
        (
            "## [1.1.1]\n\n[1.1.1]: https://asdf\n\n## [Unreleased]",
            "After compare URL definitions have started, "
            "no other line types are allowed (at line 5)",
            5,
            None,
        ),
    ],
)
def test_basic_error_line_patterns(
    changelog_contents, error_message, msg_line_no, msg_col_no
):
    try:
...
def test_invalid_streams(numerical_stream):
    try:
        ...
        assert (
            str(e)
            == 'Parameter\'s "readline" function call returned unreadable type, "int"'
        )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [{"version": 5}],
            'The value associated with the "version" key of changelog entry #1, "5", '
            'was not a semver Version or the string "Unreleased" (ignoring case)',
        ),
        (
            [{"version": "Unreleased", "date": 5}],
            'The value associated with the "date" key of '
            'changelog entry #1, "5", was not a datetime date or None',
        ),
        (
            [{"version": "Unreleased", "date": date.today(), "yanked": 5}],
